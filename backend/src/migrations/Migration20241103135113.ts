...
export class Migration20241103135113 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "room" ("uuid" varchar(255) not null, "created_at" jsonb not null, "updated_at" jsonb not null, "socket_id" varchar(255) not null, constraint "room_pkey" primary key ("uuid"));`);
